...
find_version_from_git_tags GITVERSION_VERSION "https://github.com/GitTools/GitVersion" "tags/v" "." "true"

curl -sL -o /tmp/gitversion.tar.gz "https://github.com/GitTools/GitVersion/releases/download/${GITVERSION_VERSION}/gitversion-linux-x64-${GITVERSION_VERSION}.tar.gz"
